...
const evaluationItems: EvaluationItem[] = [
  ...
  },
  {
    id: 5,
    item: "账单、资料是否完整",
    standard: "账单清晰准确、资料齐全，如有异常需用分步完成认证",
    criteria: {
      score100: "账单清晰无错误",
      score80: "3要以内错误，未造成损失",
      score60: "5要以内错误，未造成损失",
      score0: "5要以上错误未造成损失或者账单错误导致我司损失、少收、错收"
    },
    maxScore: 10
  },
  {
...
function EvaluationForm() {
  ...
  const mode = searchParams.get('mode'); // 'view' 为查看模式，其他为编辑模式
